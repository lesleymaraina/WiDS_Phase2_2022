...
# Save Dataframes
write.csv(WiDS_ozone_year,  row.names=FALSE, file=paste0('[path]/WiDS_ozone_',year,'.csv'))
write.csv(WiDS_aqi_year, row.names=FALSE, file=paste0('[path]/AQI_WiDS_Analysis/WiDS_aqi_',year,'.csv'))
